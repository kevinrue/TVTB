...
tparam <- TVTBparam(
    genos = list(
        ...
        ALT = c("1|1", "2|2")),
    ranges = GenomicRanges::GRanges( # optional
        seqnames = "15",
        IRanges::IRanges(
...
(*e.g.* burden of damaging variants in different phenotype level).
...
**Step 2:** Define VCF file imported
...
svp <- VariantAnnotation::ScanVcfParam(
    ...
    which = ranges(tparam)) # another application of the TVTBparam class
```
