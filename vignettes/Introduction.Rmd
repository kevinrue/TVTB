...
Let us show the minor allele frequency (MAF) of common variants, 
...
```{r plotInfo}
plotInfo(
        subsetByFilter(vcf, vcfRules["common"]), "MAF",
...
* in the _lower_ triangle, pairwise scatter plots of the minor allele
...
```{r pairsInfo}
pairsInfo(subsetByFilter(vcf, vcfRules["common"]), "MAF", "super_pop")
```
