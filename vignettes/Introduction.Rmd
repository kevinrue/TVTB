...
infoR <- VcfInfoRules(exprs = list(
    rare = expression(MAF < 0.01 & MAF > 0), # minor allele frequency
...
## Visualise INFO data by phenotype on a genomic axis

Let us show the minor allele frequency (MAF) of rare variants, 
...
```{r plotInfo}
plotInfo(
        subsetByFilter(vcf, vcfRules["rare"]), "MAF",
