...
* suffixes of INFO fields where counts and frequencies of genotypes are stored
    + counts and frequencies may be calculated for given levels of
        given phenotypes, in which case the corresponding INFO fields are
        formed as `<phenotype>_<level>_<suffix>`
